...
**nRFBox Pro** — это портативный мультитул для пентестинга и исследований радиоэфира на базе микроконтроллера ESP32. Устройство объединяет возможности анализа WiFi, Bluetooth, NRF24 и Sub-GHz протоколов в компактном форм-факторе.
...
В версии 2.0 полностью переписана архитектура (FreeRTOS), добавлен веб-интерфейс и улучшена стабильность.
